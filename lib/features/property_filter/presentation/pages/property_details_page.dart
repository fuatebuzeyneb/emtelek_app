...
class PropertyDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    AddAdGlobalCubit addAdGlobalCubit =
                            ...
                            ButtonWidget(
                              ...
                              onTap: () async {
                                ...
                                final Uri url = Uri.parse(
                                    'https://www.google.com/maps?q=${addAdGlobalCubit.parseLatLng(adDetails.location!).latitude},${addAdGlobalCubit.parseLatLng(adDetails.location!).longitude}');
